...
<head>
	...
	<link rel="icon" href="9060CA_logo_icai.jpg" type="image/jpg" sizes="16x16">
	...
	<div class="limiter">
		<div class="container-login100">
			<div class="wrap-login100">
				<form class="login100-form validate-form" action="companyLogin.php" method="POST">
					...
					<div class="w-full text-center p-t-27 p-b-239">
						...
						<a href="forgotPasswordCompany.php" class="txt2">
							User name / password?
						</a>
					</div>
					<div class="w-full text-center">
						<a href="employeeLogin.php" class="txt3">
							Sign In(Employee)
						</a>
					</div>
