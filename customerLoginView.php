    ...
    <div id="content-wrapper">
      ...
      <div class="container-fluid">
		...
		<input type="hidden" name= "id" value="<?php echo $_SESSION["idCustomer"];?>">
			...
			<center><b>In case of rental property,request you to get NOC signed form the owner first.<a href="">Please click here</a></b></center> 
			<br>
			<div class="form-group row justify-content-left">
				<label class="col-sm-3 col-form-label text-right"><b>In case you are operating from rented premises the upload the NOC from owner of property in PDF format</b></label>
				
				<div class="col-sm-6">
				<input type="file" name="Rent" class="form-control" value="">
				</div>
			</div>
			<div class="form-group row justify-content-left">
